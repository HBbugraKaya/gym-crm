...
import com.example.gymcrm.workload.web.error.ApiError;
...
@Configuration
@EnableConfigurationProperties(WorkloadSecurityProperties.class)
public class SecurityConfig {
    ...
    @Bean
    JwtDecoder jwtDecoder(WorkloadSecurityProperties properties) {
