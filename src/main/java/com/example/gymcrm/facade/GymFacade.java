...
public class GymFacade {
    ...
    public Trainee updateTrainee(Credentials credentials, String username, UpdateTraineeCommand command) {
        return traineeService.update(credentials, username, command);
    }

    public Trainer updateTrainer(Credentials credentials, String username, UpdateTrainerCommand command) {
        return trainerService.update(credentials, username, command);
    }
